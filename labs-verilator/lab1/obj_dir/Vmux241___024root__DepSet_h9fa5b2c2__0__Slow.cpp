...
#endif
                VL_FATAL_MT("mux241.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vmux241___024root___ctor_var_reset(Vmux241___024root* vlSelf) {
    ...
    // Body
    vlSelf->a0 = VL_RAND_RESET_I(2);
    vlSelf->a1 = VL_RAND_RESET_I(2);
    vlSelf->a2 = VL_RAND_RESET_I(2);
    vlSelf->a3 = VL_RAND_RESET_I(2);
